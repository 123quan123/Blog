...
/*   2:    */ 
/*   3:    */ import com.blog.Event.RefreshBlogType;
...
/*  21:    */ public class BlogTypeAdminController implements ApplicationContextAware
/*  22:    */ {
...
/*  29:    */   public String list(@RequestParam Integer id,@RequestParam(value="page", required=false) String page, @RequestParam(value="rows", required=false) String rows, HttpServletResponse response)
/*  30:    */     throws Exception
/*  31:    */   {
