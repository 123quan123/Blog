...
/* 66:   */     }
                String targetUrl = request.getContextPath() + "/index.do";
                System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>" + targetUrl);
/* 67:77 */     mav.addObject("pageCode", PageUtil.genPagination(targetUrl, this.blogService.getTotal(map).longValue(), Integer.parseInt(page), 10, param.toString()));
...
/* 72:   */   }
    ...
    /* 75:   */   public ModelAndView registry()
    /* 76:   */     throws Exception
    /* 77:   */   {
    /* 78:91 */     ModelAndView mav = new ModelAndView();
    /* 79:92 */     mav.setViewName("registry");
    /* 82:95 */     return mav;
        /* 83:   */   }

    @RequestMapping({"/registryBlogger"})
    /* 75:   */   public ModelAndView registryBlogger(Blogger blogger, HttpServletResponse response)
    /* 76:   */     throws Exception
    /* 77:   */   {
        /* 78:91 */     ModelAndView mav = new ModelAndView();
                        blogger.setPassword(CryptographyUtil.md5(blogger.getPassword(), "java1234"));
                        Integer save = bloggerService.save(blogger);
    /*  46: 60 */       if (save > 0) {
            /* 79:92 */     mav.setViewName("login.jsp?flag=true");
        /*  48:    */     } else {
        /*  49: 63 */        mav.setViewName("login.jsp?flag=false");
            /*  48:    */ }
        /* 82:95 */     return mav;
        /* 83:   */   }
/* 73:   */   
