...
public class BlogIndex
{
  ...
  private String lucenePath = "F:/Solr/lucene";

  private IndexWriter getWriter()
    throws Exception
  {
    this.dir = FSDirectory.open(Paths.get(lucenePath, new String[0]));
    ...
    throws Exception
  {
    ...
    doc.add(new TextField("keyWord", blog.getContentNoTag(), Field.Store.YES));
