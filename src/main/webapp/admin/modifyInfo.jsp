...
<div id="p" class="easyui-panel" title="修改个人信息" style="padding: 10px">
 ...
 <script type="text/javascript">
    ...
    <%--var ue = UE.getEditor('editore',{--%>
        ...
        <%--imageActionName:["${pageContext.request.contextPath}/ueditor/jsp/upload/file/"],--%>
        <%--// imageMaxSize:[1*1024*1000],--%>
        <%--imageAllowFiles:[".png", ".jpg", ".jpeg", ".gif"],--%>
        <%--imageUrlPrefix:["http://"+window.location.host],--%>
    <%--});--%>
